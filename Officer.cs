...
namespace Practical_Assignment_OOP
{
    class Officer
    {
        ...
        public Officer()
        {
            ...
            surname = "Snow";
            officerID = 3346;
            workingDistrict = "Central";
            crimeSolved = 19;
        }
        */
        //Argument constructor
        public Officer() : this("Janet", "Snow", 3346, "Central", 19 )
         {
         }
        ...
        public string WorkingDistrict { get => workingDistrict; set => workingDistrict = value; }
        ...
        {
            return $"{name} {surname} {officerID}, ID {officerID}, District '{workingDistrict}', Crimes solved {crimeSolved}";
        }
